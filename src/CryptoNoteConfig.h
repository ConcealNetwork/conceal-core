...
const uint64_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW = 10; /* 20 minutes */
...
const uint64_t   ZAWY_DIFFICULTY_FIX = 1;
...
const uint64_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT = 6;
